...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1447103886);
user_pref("app.update.lastUpdateTime.background-update-timer", 1447146873);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1447104205);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1447184927);
user_pref("app.update.lastUpdateTime.datareporting-healthreport-lastDailyCollection", 1447104329);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1447103766);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1447168353);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1447106939);
...
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20151103023037");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1447188319");
user_pref("browser.slowStartup.averageTime", 7434);
user_pref("browser.slowStartup.samples", 4);
user_pref("browser.startup.homepage_override.buildID", "20151103023037");
user_pref("browser.startup.homepage_override.mstone", "43.0");
user_pref("browser.syncPromoViewsLeftMap", "{\"passwords\":4,\"addons\":1,\"bookmarks\":4}");
user_pref("browser.tabs.closeWindowWithLastTab", false);
user_pref("browser.tabs.warnOnClose", false);
user_pref("browser.tabs.warnOnCloseOtherTabs", false);
user_pref("browser.tabs.warnOnOpen", false);
user_pref("browser.toolbarbuttons.introduced.pocket-button", true);
user_pref("browser.uiCustomization.state", "{\"placements\":{\"PanelUI-contents\":[\"edit-controls\",\"zoom-controls\",\"new-window-button\",\"privatebrowsing-button\",\"save-page-button\",\"print-button\",\"history-panelmenu\",\"fullscreen-button\",\"find-button\",\"preferences-button\",\"add-ons-button\",\"developer-button\"],\"liberator-statusline\":[\"liberator-mode-toolbar\",\"liberator-message-toolbar\",\"liberator-status\"],\"addon-bar\":[\"addonbar-closebutton\",\"status-bar\"],\"PersonalToolbar\":[\"personal-bookmarks\"],\"nav-bar\":[\"urlbar-container\",\"search-container\",\"webrtc-status-button\",\"bookmarks-menu-button\",\"pocket-button\",\"downloads-button\",\"home-button\",\"loop-button\",\"social-share-button\",\"noscript-tbb\",\"zotero-toolbar-buttons\"],\"TabsToolbar\":[\"tabbrowser-tabs\",\"new-tab-button\",\"alltabs-button\"],\"toolbar-menubar\":[\"menubar-items\"],\"dactyl-addon-bar\":[\"dactyl-status-bar\"]},\"seen\":[\"zotero-toolbar-buttons\",\"zotero-toolbar-main-button-single\",\"zotero-toolbar-save-button-single\"],\"dirtyAreaCache\":[\"PersonalToolbar\",\"nav-bar\",\"TabsToolbar\",\"dactyl-addon-bar\",\"PanelUI-contents\",\"addon-bar\",\"toolbar-menubar\",\"liberator-statusline\"],\"currentVersion\":4,\"newElementCount\":0}");
...
user_pref("datareporting.sessions.current.firstPaint", 7435);
user_pref("datareporting.sessions.current.main", 1603);
user_pref("datareporting.sessions.current.sessionRestored", 8669);
user_pref("datareporting.sessions.current.startTime", "1447188311335");
user_pref("datareporting.sessions.current.totalTime", 28);
user_pref("datareporting.sessions.currentIndex", 86);
user_pref("datareporting.sessions.previous.74", "{\"s\":1447103954538,\"a\":64,\"t\":692,\"c\":true,\"m\":758,\"fp\":4496,\"sr\":4809}");
user_pref("datareporting.sessions.previous.75", "{\"s\":1447104654252,\"a\":14,\"t\":114,\"c\":true,\"m\":40,\"fp\":2690,\"sr\":3052}");
user_pref("datareporting.sessions.previous.76", "{\"s\":1447104771023,\"a\":17,\"t\":109,\"c\":true,\"m\":43,\"fp\":2172,\"sr\":2978}");
user_pref("datareporting.sessions.previous.77", "{\"s\":1447104896018,\"a\":5,\"t\":36,\"c\":true,\"m\":42,\"fp\":2065,\"sr\":2714}");
user_pref("datareporting.sessions.previous.78", "{\"s\":1447104937902,\"a\":9,\"t\":68,\"c\":true,\"m\":41,\"fp\":2065,\"sr\":2703}");
user_pref("datareporting.sessions.previous.79", "{\"s\":1447105009727,\"a\":6,\"t\":68,\"c\":true,\"m\":41,\"fp\":2078,\"sr\":2728}");
user_pref("datareporting.sessions.previous.80", "{\"s\":1447105081920,\"a\":9,\"t\":74,\"c\":true,\"m\":56,\"fp\":2240,\"sr\":2906}");
user_pref("datareporting.sessions.previous.81", "{\"s\":1447105280710,\"a\":13,\"t\":72,\"c\":true,\"m\":40,\"fp\":2109,\"sr\":2741}");
user_pref("datareporting.sessions.previous.82", "{\"s\":1447105430338,\"a\":20,\"t\":175,\"c\":true,\"m\":42,\"fp\":2064,\"sr\":2696}");
user_pref("datareporting.sessions.previous.83", "{\"s\":1447105606540,\"a\":204,\"t\":4136,\"c\":true,\"m\":34,\"fp\":2654,\"sr\":3182}");
user_pref("datareporting.sessions.previous.84", "{\"s\":1447109742948,\"a\":677,\"t\":75601,\"c\":true,\"m\":372,\"fp\":4023,\"sr\":4680}");
user_pref("datareporting.sessions.previous.85", "{\"s\":1447187506162,\"a\":31,\"t\":242,\"c\":true,\"m\":2399,\"fp\":13131,\"sr\":14768}");
...
user_pref("extensions.enabledAddons", "zotero%40chnm.gmu.edu:4.0.28.7,%7Bcccd1663-fea2-4098-8d6d-9d1790b76b2d%7D:1.0.1,%7B73a6fe31-595d-460b-a920-fcc0f8843232%7D:2.6.9.39,vimperator%40mozdev.org:3.10.1,%7B972ce4c6-7e08-4474-a285-3208198ce6fd%7D:43.0");
user_pref("extensions.getAddons.cache.lastUpdate", 1447103887);
...
user_pref("gecko.buildID", "20151103023037");
user_pref("gecko.mstone", "43.0");
user_pref("general.autoScroll", false);
user_pref("general.smoothScroll", false);
user_pref("general.warnOnAboutConfig", false);
user_pref("idle.lastDailyNotification", 1447110127);
user_pref("media.gmp-gmpopenh264.lastUpdate", 1444165516);
user_pref("media.gmp-gmpopenh264.version", "1.4");
user_pref("media.gmp-manager.buildID", "20151103023037");
user_pref("media.gmp-manager.lastCheck", 1447105670);
...
user_pref("noscript.subscription.lastCheck", -215653968);
...
user_pref("toolkit.startup.last_success", 1447188312);
user_pref("toolkit.telemetry.cachedClientID", "63799d36-2afc-c149-bd54-298747335fd6");
user_pref("toolkit.telemetry.enabled", false);
user_pref("toolkit.telemetry.previousBuildID", "20151103023037");
